...
const PlanCard = ({ title, image, paragraph, borderColor, imageSize }) => {
  // Define el número de WhatsApp en formato internacional
  const whatsappNumber = "573147401115";
